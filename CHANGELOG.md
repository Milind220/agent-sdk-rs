...
## [0.1.3](https://github.com/Milind220/agent-sdk-rs/compare/v0.1.2...v0.1.3) - 2026-02-28

### Fixed

- *(cargo)* improve crates.io discovery metadata ([#6](https://github.com/Milind220/agent-sdk-rs/pull/6))
...
- add Google GenAI-compatible LLM adapter from codex/feat-google-genai-llm

### Other

- add release-plz workflow and config ([#2](https://github.com/Milind220/agent-sdk-rs/pull/2))
